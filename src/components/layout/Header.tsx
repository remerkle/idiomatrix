      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 h-16 flex items-center gap-2">
        ...
        <div className="relative flex-1 min-w-0">
          <nav
            ...
            className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
            {[
              ...
              <NavLink
                ...
                to={to}
                className={({ isActive }) =>
                  `shrink-0 whitespace-nowrap px-3 sm:px-5 py-2 rounded-full font-semibold text-xs sm:text-sm transition-colors ${
                    isActive
